...
- Docker images pushed to ghcr.io/saltxd/agentguard-* — **NEEDS RENAME**
...
4. **Update Docker image names** to `ghcr.io/saltxd/chainward-api`, `chainward-web`, `chainward-worker`
...
1. **GitHub Actions workflow** — on push to `main`:
   ...
   - Push to ghcr.io/saltxd/chainward-*
