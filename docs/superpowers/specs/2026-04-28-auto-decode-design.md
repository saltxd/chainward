...
- **Loads voice context** by reading `~/.claude/projects/-Users-saltxd-Forge/memory/feedback_voice_chainward_threads.md` once at start (so writer + voice-verifier share the same canonical voice spec).
