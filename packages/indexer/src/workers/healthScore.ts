// Re-export the pure formula so callers can import from either file.
export { computeHealthScore, type HealthInputs } from './healthScore-formula.js';

import { computeHealthScore } from './healthScore-formula.js';
import type { HealthInputs } from './healthScore-formula.js';
