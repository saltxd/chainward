...
// the fixtures were captured around 2026-04-30).
...
const EXPECTED: Record<string, Golden> = {
  'axelrod-active': { acp_id: 129, name: 'Axelrod', wallet_type: 'erc1967_proxy', survival: 'active', usdc_pattern: 'running', eth_wei: '0', usdc_amount: 0, transfers_24h: 13, transfers_7d: 47, transfers_30d: 50, unique_counterparties_30d: 10, transfers_fetched: 50, discrepancies: 0 },
  'ethy-borderline': { acp_id: 84, name: 'Ethy AI', wallet_type: 'erc1967_proxy', survival: 'at_risk', usdc_pattern: 'running', eth_wei: '0', usdc_amount: 0, transfers_24h: 2, transfers_7d: 4, transfers_30d: 49, unique_counterparties_30d: 13, transfers_fetched: 50, discrepancies: 0 },
  'lucien-dormant': { acp_id: 59, name: 'Director Lucien', wallet_type: 'erc1967_proxy', survival: 'dormant', usdc_pattern: 'inactive', eth_wei: '0', usdc_amount: 0, transfers_24h: 0, transfers_7d: 0, transfers_30d: 3, unique_counterparties_30d: 3, transfers_fetched: 50, discrepancies: 1 },
  'luna-dormant': { acp_id: 74, name: 'Luna', wallet_type: 'erc1967_proxy', survival: 'dormant', usdc_pattern: 'inactive', eth_wei: '0', usdc_amount: 0, transfers_24h: 0, transfers_7d: 0, transfers_30d: 0, unique_counterparties_30d: 0, transfers_fetched: 50, discrepancies: 1 },
  'otto-active': { acp_id: 788, name: 'Otto AI - Trade Execution Agent', wallet_type: 'erc1967_proxy', survival: 'active', usdc_pattern: 'running', eth_wei: '0', usdc_amount: 0, transfers_24h: 35, transfers_7d: 50, transfers_30d: 50, unique_counterparties_30d: 7, transfers_fetched: 50, discrepancies: 0 },
};
...
describe('Layer A — golden decode assertions (quickDecode struct)', () => {
  it.each(Object.entries(EXPECTED))('%s decodes to the verified struct', async (name, g) => {
    ...
    // discrepancies (ACP claim vs chain reality)
    expect(d.discrepancies).toHaveLength(g.discrepancies);
